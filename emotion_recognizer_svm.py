...
data = pd.read_csv('mytrainingdata.csv')
#data = data.iloc[:7000,:]
...
x_train,y_train=data.content, data.sentiment
...
prediction_df = pd.DataFrame({'Content':x_test, 'Emotion_predicted':predicted_sentiment})
